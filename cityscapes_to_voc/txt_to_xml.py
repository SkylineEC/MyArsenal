...
#  图像存储位置
src_img_root_dir = "/home/jiawen/proj/cityscapes/leftImg8bit_trainvaltest/leftImg8bit/train/"
#  图像的 ground truth 的 txt 文件存放位置
src_txt_root_dir = "/home/jiawen/proj/cityscapes/gtFine_trainvaltest/gtFine/train/"
src_xml_root_dir = "/home/jiawen/proj/VOC2007/Annotations/"
dst_img_dir = "/home/jiawen/proj/VOC2007/JPEGImages/"
#最大文件量为2000
MAX_SIZE = 2000
...
for regionNameDir in os.listdir(src_img_root_dir):
    ...
    for img in tqdm(img_names):
        ...
        if len(tmp_list) == 0:
            continue
        xmlName = img + ".xml"
        xml_filename =  os.path.join(src_xml_root_dir,xmlName)
