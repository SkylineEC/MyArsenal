...
if __name__ == '__main__':
    ...
    T_images = "/home/jiawen/proj/MyArsenal/make_voc_dataset/VOC2007/JPEGImages"
    
    T_annotations = "/home/jiawen/proj/MyArsenal/make_voc_dataset/VOC2007/Annotations"
    
    #move_file(S_images,S_annotations,".jpg")
    #move_file(T_images,T_annotations,".xml")
    
    
    move_file(S_annotations,T_images,".jpg")
